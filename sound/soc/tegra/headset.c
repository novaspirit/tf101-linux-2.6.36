...
extern int tegra_play_route_put(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol);
...
{
	printk(KERN_ERR "AUDIO_CODEC: headset inserted\n");
	...
	tegra_play_route_put(0, 0);
}

static void remove_headset(void)
{
	printk(KERN_ERR "AUDIO_CODEC: headset removed\n");
